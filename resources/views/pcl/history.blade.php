    ...
    <div class="space-y-6">
        ...
        <div class="p-6 bg-white border border-gray-200 rounded-2xl shadow-sm dark:bg-gray-900 dark:border-gray-800 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Menampilkan seluruh riwayat pengiriman capaian harian yang telah Anda input.</p>
            </div>
            <div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                        @forelse($reports as $report)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                ...
                                <td class="px-6 py-4 text-center flex items-center justify-center gap-2">
                                    ...
                                    <!-- Delete Form (Admin Only, or PCL can do if needed, checked by policy) -->
                                    @can('delete', $report)
                                        <form method="POST" action="{{ route('daily-reports.destroy', $report) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus laporan ini?');">
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="px-6 py-12 text-center text-gray-500">Anda belum pernah mengirimkan laporan capaian harian.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
